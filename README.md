...
### 📡 FIIT Meteo Protocol (FMP)
*Custom IoT network protocol over UDP.*
- **Core:** Binary bit-packing (96% more efficient than JSON), CRC integrity, and token-based auth.
- **Tools:** Java Server/Client, Wireshark Lua Disector for packet analysis.
- **Focus:** Low-level data optimization and reliable network communication.
